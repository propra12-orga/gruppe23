...
public class Map extends JPanel {
	...
	// map[Menue.get_bot(Botnummer).get_x()][Menue.get_bot(Botnummer).get_y()] =
	// 2;
	// map[Menue.get_bot(Botnummer).get_x() + x][Menue.get_bot(Botnummer)
	// .get_y() + y] = 10;
	//
	// /* Logische Fortbewegung der Spielfigur: */
	// Menue.get_bot(Botnummer).set_x(Menue.get_bot(Botnummer).get_x() + x); //
	// setze horizontale Hulk-Position weiter
	// Menue.get_bot(Botnummer).set_y(Menue.get_bot(Botnummer).get_y() + y); //
	// setze vertikale Hulk-Position weiter
	//
	...
	// bomb[bomb_x][bomb_y].aktivieren(0,
	// Menue.get_bot(botnummer).get_bomben_radius()); // Bombe aktivieren
	...
	public void move_Hulk(int x, int y, int z) {
		...
		if (map[Menue.get_hulk(z).get_x() + x][Menue.get_hulk(z).get_y() + y] == 12 // falls
																					// das
																					// naechste
																					// Feld
																					// das
		...
		if (map[Menue.get_hulk(z).get_x() + x][Menue.get_hulk(z).get_y() + y] == 15) { // falls
			...
			Menue.get_hulk(z).set_bomben_radius(
					Menue.get_hulk(z).get_bomben_radius() + 1); // ...dann
																// erhoehe die
																// maximale
																// Anzahl an
																// Bomben um 1
		...
		if (z == 1) {
			...
			map[Menue.get_hulk(z).get_x() + x][Menue.get_hulk(z).get_y() + y] = 10; // weise
																					// dem
																					// naechsten
																					// Feld
																					// das
		...
		/* Logische Fortbewegung der Spielfigur: */
		Menue.get_hulk(z).set_x(Menue.get_hulk(z).get_x() + x); // setze
																// horizontale
																// Hulk-Position
																// weiter
		Menue.get_hulk(z).set_y(Menue.get_hulk(z).get_y() + y); // setze
																// vertikale
																// Hulk-Position
																// weiter
